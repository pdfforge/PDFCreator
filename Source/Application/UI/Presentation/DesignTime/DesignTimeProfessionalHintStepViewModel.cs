...
namespace pdfforge.PDFCreator.UI.Presentation.DesignTime
{
    ...
    {
        public DesignTimeProfessionalHintStepViewModel() : base(new DesignTimeTranslationUpdater(), new DesignTimeCommandLocator(), new DesignTimeConditionalHintManager())
        {
        }
    }
}
