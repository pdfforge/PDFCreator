...
{
    public class BackgroundActionViewModel : ActionViewModelBase<BackgroundAction, BackgroundSettingsAndActionTranslation>
    {
        ...
        public BackgroundActionViewModel(IActionLocator actionLocator,
