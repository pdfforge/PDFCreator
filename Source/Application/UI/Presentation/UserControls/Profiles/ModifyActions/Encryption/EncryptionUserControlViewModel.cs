...
{
    public class EncryptionUserControlViewModel : ActionViewModelBase<EncryptionAction, EncryptionUserControlTranslation>
    {
        private readonly IInteractionRequest _interactionRequest;
        private readonly EditionHelper _editionHelper;

        public EncryptionUserControlViewModel
