...
{
    public class EncryptionPasswordsOverlayViewModel : OverlayViewModelBase<EncryptionPasswordInteraction, EncryptionPasswordsOverlayTranslation>
    {
        private readonly ZxcvbnProvider _zxcvbnProvider;
        public bool AllowConversionInterrupts { get; set; } = true;

        public EncryptionPasswordsOverlayViewModel(ITranslationUpdater updater, ZxcvbnProvider zxcvbnProvider) : base(updater)
        {
    ...
    public class DesignTimeEncryptionPasswordsOverlayViewModel : EncryptionPasswordsOverlayViewModel
    {
        public DesignTimeEncryptionPasswordsOverlayViewModel() : base(new DesignTimeTranslationUpdater(), null)
        {
        }
    }
}
