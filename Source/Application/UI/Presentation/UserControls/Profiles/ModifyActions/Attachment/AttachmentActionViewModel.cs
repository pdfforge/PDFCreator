...
{
    public class AttachmentActionViewModel : ActionViewModelBase<AttachmentAction, AttachmentSettingsAndActionTranslation>
    {
        ...
        public AttachmentActionViewModel(IActionLocator actionLocator,
