...
{
    public class PageNumbersActionViewModel : ActionViewModelBase<PageNumbersAction, PageNumbersTranslation>
    {
        ...
        public PageNumbersActionViewModel(ITranslationUpdater translationUpdater, IDispatcher dispatcher,
